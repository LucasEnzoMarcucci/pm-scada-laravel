 ...
 */
    ...
    *,
    ...
    .app-sidebar {
      ...
      transition: min-width .3s ease-in-out, max-width .3s ease-in-out, margin-left .3s ease-in-out, margin-right .3s ease-in-out
    }
    ...
    .sidebar-brand .brand-text {
      ...
      transition: flex .3s ease-in-out, width .3s ease-in-out
    }
    ...
    .callout {
      ...
      border-left: .25rem solid var(--lte-callout-border, var(--bs-gray-300))
    }
    ...
    .info-box .progress {
      height: 2px;
      margin: 5px 0;
      background-color: rgba(var(--lte-card-variant-color-rgb), .125)
    }
